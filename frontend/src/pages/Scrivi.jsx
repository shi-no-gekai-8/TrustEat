...
function Scrivi() {
  ...
  const pubblica = async () => {
    ...
    try {
      // *** MODIFICA FONDAMENTALE: PORTA 5000 ***
      await axios.post("http://localhost:5000/api/bacheca/scrivi", {
      ...
      console.error(error);
      alert("Errore nell'invio. Verifica che il server (porta 5000) sia acceso.");
    }
  };
    ...
    <div>
      ...
      <div style={{ maxWidth: "600px", margin: "50px auto", padding: "20px", textAlign: "center" }}>
        ...
        <textarea
          ...
          style={{ width: "100%", padding: "15px", fontSize: "16px", borderRadius: "10px", marginBottom: "20px" }}
        />
        
        <button 
          onClick={pubblica}
          style={{ padding: "15px 30px", fontSize: "18px", backgroundColor: "#27ae60", color: "white", border: "none", borderRadius: "10px", cursor: "pointer" }}
        >
